...
#define __P_DEF_0  X,        // !!!here is a comma!!!
#define __P_DEF_1  X,        // CHOOSE2nd(contain_comma a,b) will be expanded
#define __P_ONE_1  X,        // to CHOOSE2nd(X,a,b) if __P_DEF_* is defined
#define __P_ZERO_0 X,        // !!!here is a comma!!!
